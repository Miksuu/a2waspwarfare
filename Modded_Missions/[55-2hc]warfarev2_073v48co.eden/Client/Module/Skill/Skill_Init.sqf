...
<<<<<<<< HEAD:Missions_Vanilla/[61-2hc]warfarev2_073v48co.takistan/Client/Module/Skill/Skill_Init.sqf
WFBE_SK_V_Engineers = ['USMC_SoldierS_Engineer','BAF_Soldier_EN_DDPM','MVD_Soldier_TL','US_Soldier_Engineer_EP1','TK_Soldier_Engineer_EP1','CDF_Soldier_Engineer','Ins_Soldier_Sapper','USMC_Soldier_TL','BAF_Soldier_SL_DDPM','Ins_Soldier_CO','TK_Soldier_Officer_EP1','US_Soldier_Officer_EP1'];
...
>>>>>>>> AntiStackPreparation:Modded_Missions/[55-2hc]warfarev2_073v48co.eden/Client/Module/Skill/Skill_Init.sqf
