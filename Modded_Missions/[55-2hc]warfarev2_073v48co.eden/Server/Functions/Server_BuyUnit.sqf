...
if (_unitType isKindOf "Man") then {
	...
	if ({(typeOf _vehicle) isKindOf _x} count ["LAV25_Base","M2A2_Base","BMP2_Base","BTR90_Base","Pandur2_ACR"] != 0) then {_vehicle addeventhandler ["fired",{_this spawn HandleReload;}]};
