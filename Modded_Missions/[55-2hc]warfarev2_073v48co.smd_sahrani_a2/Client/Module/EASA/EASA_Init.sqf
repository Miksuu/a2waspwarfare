...
[3400,'AIM-9L (2) | AGM-114 (8)',[['SidewinderLaucher_AH1Z','HellfireLauncher'],['2Rnd_Sidewinder_AH1Z','8Rnd_Hellfire']]]
]
];

// Wildcat AH11 [AF3] - 4 pylons
_easaVehi = _easaVehi + ['AW159_Lynx_BAF'];
_easaDefault = _easaDefault + [[['CTWS','CRV7_HEPD','SpikeLauncher_ACR'],['200Rnd_40mmHE_FV510','200Rnd_40mmSABOT_FV510','6Rnd_CRV7_HEPD','2Rnd_Spike_ACR','2Rnd_Spike_ACR']]];
_easaLoadout = _easaLoadout + [
[
