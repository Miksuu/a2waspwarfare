...
Private ["_defence", "_groups", "_moveInGunner", "_positions", "_retVal", "_side", "_team", "_teams", "_town", "_townDefenderAI", "_town_vehicles"];
...
// Marty: Optional town owner is passed through for exact cleanup ownership.
...
// Marty: Preserve the town-defender marker and town owner when this static unit is created on a client or HC.
_retVal = [_side, _groups, _positions, _team, _defence, _moveInGunner, _townDefenderAI, _town] call WFBE_CO_FNC_CreateUnitForStaticDefence;
