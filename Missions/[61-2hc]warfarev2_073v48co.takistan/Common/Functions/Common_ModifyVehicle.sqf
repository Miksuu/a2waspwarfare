...
switch (_type) do {
	...
	case "F35B":{
		_rearmor = {
   			...
   			_result = 0;
   			switch (_ammo) do {
				case "B_25mm_HE" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
				case "B_30mmA10_AP" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
				case "B_30mm_HE" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
				case "B_77x56_Ball" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
				case "B_20mm_AP" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
				case "B_23mm_APHE" :{_dam=_this select 2; _p=99; _result=(_dam/100)*(100-_p);};
     			default {_result = _this select 2;};
    		};
   			_result
  		};
