...
Private ["_context","_group","_groupLocal","_leader","_machine","_players","_side","_source"];
...
["INFORMATION", Format ["GROUP_TRACE create machine:%1 source:%2 side:%3 group:%4 context:%5 local:%6 units:%7 total:%8 players:%9", _machine, _source, _side, _group, _context, _groupLocal, (count (units _group)), (count allGroups), _players]] Call WFBE_CO_FNC_LogContent;
