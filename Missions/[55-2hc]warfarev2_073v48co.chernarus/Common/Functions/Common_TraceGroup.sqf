...
Private ["_context","_group","_machine","_side","_source"];
...
["INFORMATION", Format ["GROUP_TRACE create machine:%1 source:%2 side:%3 group:%4 context:%5 local:%6 units:%7 total:%8", _machine, _source, _side, _group, _context, local _group, (count (units _group)), (count allGroups)]] Call WFBE_CO_FNC_LogContent;
