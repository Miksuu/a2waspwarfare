...
Private ["_groups", "_lock", "_logGroupCount", "_position", "_positions", "_retVal", "_side", "_sideID", "_team", "_teams", "_town", "_town_teams", "_town_vehicles", "_vehicles"];
...
_logGroupCount = {
	Private ["_event", "_groupCountCiv", "_groupCountEast", "_groupCountGuer", "_groupCountLogic", "_groupCountSide", "_groupCountWest", "_groupCountUnknown", "_groupMachine", "_groupSide", "_level", "_players"];
	...
	// Marty: Add human players to group pressure logs for production correlation.
	[_level, Format ["TOWN_GROUP_COUNT %1 machine:%2 town:%3 side:%4 sideGroups:%5 total:%6 players:%7 west:%8 east:%9 guer:%10 civ:%11 logic:%12 unknown:%13", _event, _groupMachine, _town getVariable "name", _side, _groupCountSide, count allGroups, _players, _groupCountWest, _groupCountEast, _groupCountGuer, _groupCountCiv, _groupCountLogic, _groupCountUnknown]] Call WFBE_CO_FNC_LogContent;
};
