...
//--- Towns.
	...
	if (isNil "WFBE_C_TOWNS_PATROLS") then {WFBE_C_TOWNS_PATROLS = 0}; //--- Town-to-town patrols OFF by default; DR-57 fix makes them work when set >0 (number of towns) in the lobby.
