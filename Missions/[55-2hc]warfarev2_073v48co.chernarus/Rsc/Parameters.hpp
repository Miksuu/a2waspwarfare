/* Parameters */
	...
	class WFBE_C_ECONOMY_FUNDS_START_EAST {
		...
		values[] = {800,1600,2400,3200,4000,4800,6400,8000,12800,25600,38400,51200,102400,204800,409600,819200};
		texts[] = {"$ 800","$ 1600","$ 2400","$ 3200","$ 4000","$ 4800","$ 6400","$ 8000","$ 12800","$ 25600","$ 38400""$ 51200","$ 102400","$ 204800","$ 409600","$ 819200"};
		default = 38400;
	};
