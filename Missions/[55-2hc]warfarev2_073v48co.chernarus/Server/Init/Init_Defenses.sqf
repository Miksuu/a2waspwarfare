...
missionNamespace setVariable ['WFBE_NEURODEF_BARRACKS_WALLS',[
	...
	//['Land_HBarrier_large',[0.5,-11,0],180], // Commented out to create an opening on the south side
	...
	//['Land_HBarrier_large',[0.5,13,0],180], // Commented out to create an opening on the north side
	['Land_HBarrier_large',[-6,13,0],180],
	//['Land_HBarrier_large',[-9.5,9.5,0],90] // Commented out to create an opening on the west side
]];
...
missionNamespace setVariable ['WFBE_NEURODEF_LIGHT_WALLS',[
	...
	//['Land_HBarrier_large',[0,-12,0],180], // Commented out to create an opening on the south side
	['Land_HBarrier_large',[-7,-12,0],180],
	['Land_HBarrier_large',[7,12,0],180],
	//['Land_HBarrier_large',[0,12,0],180], // Commented out to create an opening on the north side
	['Land_HBarrier_large',[-7,12,0],180],
	['Land_HBarrier_large',[-11,-9,0],90],
	//['Land_HBarrier_large',[-11,-1.5,0],90], // Commented out to create an opening on the west side
...
missionNamespace setVariable ['WFBE_NEURODEF_HEAVY_WALLS',[
	...
	//['Land_HBarrier_large',[4.5,-14.5,0],180], // Commented out to create an opening on the south side
	['Land_HBarrier_large',[-3,-14.5,0],180],
	['Land_HBarrier_large',[-10.5,-14.5,0],180],
	['Land_HBarrier_large',[-14,-11,0],90],
	//['Land_HBarrier_large',[-14,-3.5,0],90], // Commented out to create an opening on the west side
	['Land_HBarrier_large',[-14,4,0],90],
	['Land_HBarrier_large',[-14,9.5,0],90],
	['Land_HBarrier_large',[11,13,0],180],
	//['Land_HBarrier_large',[3.5,13,0],180], // Commented out to create an opening on the north side
