...
for "_i" from 0 to (count _template - 1) do {
	...
	//--- Stock defense builder: guns get manned + scored + artillery-enabled; props get placed. Identical to a hand-built defense.
	_one = [_cls, _side, _worldPos, _worldDir, _manned, false] Call ConstructDefense;
