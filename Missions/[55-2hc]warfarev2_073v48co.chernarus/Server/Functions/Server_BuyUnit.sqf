...
if (_unitType isKindOf "Man") then {
	...
	if ({(typeOf _vehicle) isKindOf _x} count ["LAV25_Base","M2A2_Base","BMP2_Base","BTR90_Base","Pandur2_Base","BAF_FV510_W"] != 0) then {_vehicle addeventhandler ["fired",{_this spawn HandleReload;}]};
