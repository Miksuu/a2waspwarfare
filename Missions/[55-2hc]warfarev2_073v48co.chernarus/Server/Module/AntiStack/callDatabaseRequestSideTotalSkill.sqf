...
//--- PR8 (claude): DB extension absent/unreachable -> callExtension returns "" and "call compile" yields nil; exit before "select 1" to avoid the undefined-variable RPT cascade.
