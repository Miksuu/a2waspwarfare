...
WFBE_Client_Teams_West = clientTeamsWest;
WFBE_Client_Teams_East = clientTeamsEast;
WFBE_Client_Teams_West_Count = count WFBE_Client_Teams_West;
WFBE_Client_Teams_East_Count = count WFBE_Client_Teams_East;
WFBE_Client_Teams_Both = WFBE_Client_Teams_West + WFBE_Client_Teams_East;
WFBE_Client_Teams_Both_Count = count WFBE_Client_Teams_Both;
...
[] execVM "Client\Module\Camera\FSM\CAM_client_both_title_capture.sqf";
