...
switch (_request) do {
	...
	case "attack-wave": {diag_log "ATTACK_WAVE_PRICE_MODIFIER:"; diag_log ATTACK_WAVE_PRICE_MODIFIER; ATTACK_WAVE_PRICE_MODIFIER = (_args select 0); diag_log ATTACK_WAVE_PRICE_MODIFIER;};
};