...
//changed to get mapmarker on dedicated host

private _spawnpos_plane=(_ranPos select _ran);
_spawnpos_plane=[_spawnpos_plane#0,_spawnpos_plane#1,_spawnpos_plane#2+1000];//spawnfix for ru plane#not works here
