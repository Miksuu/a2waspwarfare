...
class RscTitles {
	...
	class OptionsAvailable {
		...
		class RUBHUD_Background : RscText {
			idc = 1345;
			x = 0.852584 * safezoneW + safezoneX;
			y = 0.7175 * safezoneH + safezoneY;
			w = 0.107 * safezoneW;
			h = 0.0012 * safezoneH;
			colorBackground[] = {0,0,0,0};
		};
		...
		class RUBHUD_Health : RscText
		{
			idc = 1346;
			text = "";
			x = 0.851708 * safezoneW + safezoneX;
			y = 0.69626 * safezoneH + safezoneY;
		...
		class RUBHUD_Health_Value : RscText
		{
			idc = 1347;
			text = "";
			x = 0.891938 * safezoneW + safezoneX;
			y = 0.69626 * safezoneH + safezoneY;
			w = 0.7977083 * safezoneW;
			h = 0.0228518 * safezoneH;
			sizeEx = 0.035;
		...
		class RUBHUD_Money: RscText {
			...
			text = "";
			x = 0.851708 * safezoneW + safezoneX;
			y = 0.756000 * safezoneH + safezoneY;
			w = 0.1025 * safezoneW;
			h = 0.0255556 * safezoneH;
			sizeEx = 0.030;
			colorText[] = {1,1,1,1};
		...
		class RUBHUD_Supply: RscText {
			...
			text = "";
			x = 0.851708 * safezoneW + safezoneX;
			y = 0.796000 * safezoneH + safezoneY;
			w = 0.1025 * safezoneW;
			h = 0.0255556 * safezoneH;
			sizeEx = 0.030;
			colorText[] = {1,1,1,1};
		...
		class RUBHUD_City: RscText {
			...
			text = "";
			x = 0.851708 * safezoneW + safezoneX;
			y = 0.836000 * safezoneH + safezoneY;
			w = 0.1025 * safezoneW;
			h = 0.0255556 * safezoneH;
			sizeEx = 0.030;
			colorText[] = {1,1,1,1};
