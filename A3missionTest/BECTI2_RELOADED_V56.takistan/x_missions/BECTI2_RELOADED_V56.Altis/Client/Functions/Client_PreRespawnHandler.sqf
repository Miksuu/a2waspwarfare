...
//player addAction [(localize "STR_BECTI2_toogle_primary"),{inputAction "SwitchPrimary"},,1,false,true,'',((!((primaryWeapon player)=="")) && (!((currentWeapon player)==(primaryWeapon player))))];
//player addAction [(localize "STR_WF_TOOLTIP_FilterButtonSidearm"),{inputAction "SwitchHandgun"},,1,false,true,'',((!((handgunWeapon player)=="")) && (!((currentWeapon player)==(handgunWeapon player))))];
//player addAction [(localize "STR_BECTI2_toogle_secondary"),{inputAction "SwitchSecondary"},,1,false,true,'',((!((secondaryWeapon player)==""))&& (!((currentWeapon player)==(secondaryWeapon player))))];
