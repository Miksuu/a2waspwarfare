	...
	{
		hintSilent composeText [parseText format ["<t align='left' size='%4'><img image='%3'></t>"+"<t align='center' size='1.25' shadow='true'>%1</t><t align='right' size='%4'><img image='%3'></t>" +"<br/>" +"<t align='center' size='1.5' shadow='true'>%2</t>",localize "STR_HINT_ParaOpen",_times select _i,"\warfare_core\Images\para_ca.paa",1.0]];
		sleep 0.2;
	};
	hintSilent "";
