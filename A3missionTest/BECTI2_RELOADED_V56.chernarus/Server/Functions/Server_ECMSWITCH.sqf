...
_unit = _this#0#0#0;//the ECM source object "ECMunit"
_actionID= _this#0#0#2;
...
_MARKERSWITCH=5;
		...
		//maker temp marker for update (this just keep it black,without update is visible for some frames)
		_tmarkername= str _unit;
		_tmarkername=_tmarkername+"t" ;
		
		for "_i" from 1 to 13 do { 
		createMarker [_tmarkername, _unit,0]; 
		_tmarkername setMarkerShape "ELLIPSE"; 
		_tmarkername setMarkerSize [3000, 3000]; 
		_tmarkername setMarkerBrush "SolidFull"; 
		_tmarkername=_tmarkername+"1";
		 };
		for "_i" from 1 to 7 do { 
		createMarker [_tmarkername, _unit,0]; 
		_tmarkername setMarkerType "loc_Transmitter"; 
		_tmarkername setMarkerSize [1, 1]; 
		_tmarkername=_tmarkername+"1";
		};

		//__________________________________________________________________________________________________________main update
		...
		//__________________________________________________________________________________________________________delete tempmarker
		_tmarkername= str _unit;
		_tmarkername=_tmarkername+"t" ;
		for "_i" from 0 to 19 do { 
		deleteMarker _tmarkername;
		_tmarkername=_tmarkername+"1";
		};
